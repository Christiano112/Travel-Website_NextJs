...
const Subscribe = () => {
    return (
        <article className='mt-[7rem] mx-auto w-[84%] sm:w-[80%] bg-[#DFD7F9] flex flex-col justify-center items-center p-6 sm:p-12 relative rounded-2xl rounded-tl-[3rem] sm:rounded-tl-[6rem]'>
            ...
            <Image src='/images/crosses.png' alt='crosses' height='100' width='100' className='absolute bottom-0 right-0 hidden sm:block mr-[-3rem] rotate-90' />
        </article>
    )
}
